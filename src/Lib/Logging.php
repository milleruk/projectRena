...
class Logging
{
				...
				public function __construct(RenaApp $app)
				{
								...
								$this->logger->pushHandler(new StreamHandler($this->app->baseConfig->getConfig('logFile', 'Logging', __DIR__ . '/../../logs/app.log'), $this->config->getConfig("logLevel", "Logging", 100)));
